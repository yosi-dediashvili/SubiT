...
class SratimHandler(ISubHandler):
    ...
    def findmovieslist( subSearch ):
        ...
        if SratimHandler.isSeries(searchresult):
        ...
        for type, results in groupby(movie_results, lambda i: i['type']):
            ...
            if type == 'movie':
                ...
                for result in results:
                    ...
                    subMovies.append(SubResult.SubMovie(moviecode, moviename, default_versum, ))
            ...
            #Handle serieses results
                ...
                for result in results:
                    ...
                    total_seasons       = SratimHandler.getSeasonsList(seriescode)
                    ...
                    for season in total_seasons:
                        ...
                        total_episodes = SratimHandler.getEpisodesList(seriescode, seasoncode)
    ...
    def findversionslist( subMovie ):
        ...
        #Otherwise, it's dict -> will be for season's episode
            ...
            SratimHandler.getVersionsList(episode_page)
            for episode_ver in filter(lambda f: f['Language'] == SRATIM_PAGES.LANGUAGE and f['VerSum'] != '', SratimHandler.getVersionsList(episode_page)):
