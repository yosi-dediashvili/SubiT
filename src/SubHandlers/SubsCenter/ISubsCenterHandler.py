...
class ISubsCenterHandler(ISubHandler):
    HANDLER_NAME = 'Base - www.subscenter.org'
    ...
    def findmovieslist( subSearch ):
        ...
        for movie_info in movies_info:
            ...
            if movie_type == 'movie':
                ...
                (ver_sum, all_versions) = ISubsCenterHandler.getVersionsList(versions_area_content)
            ...
            #If the result is series
                ...
                all_episodes        = ISubsCenterHandler.getEpisodesList(series_area_content)
    ...
    def findversionslist( subMovie ):
        ...
        #Else, on series, we still got work to do
            ...
            (ver_sum, sub_versions) = ISubsCenterHandler.getVersionsList(versions_area_content)            
