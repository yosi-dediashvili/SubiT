...
class LOGS:
	...
	class WARN:
		...
		OS_CANT_GET_MOVIE_NAME_FOR_FILE_NAME            = 'WARN__||__Can\'t get movie name using the file name'
	...
	class INFO:
		...
		OS_SENDING_QUERY_USING_THE_FILE_HASH_VALUE          = 'INFO__||__Sending query to www.OpenSubtitles.org using the file hash value'
		OS_SENDING_QUERY_USING_THE_FILE_NAME                = 'INFO__||__Sending query to www.OpenSubtitles.org using the file name'
		...
		APPLICATION_WILL_NOW_EXIT                           = 'INFO__||__Application will now exit'
